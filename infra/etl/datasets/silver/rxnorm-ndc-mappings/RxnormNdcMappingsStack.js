 ...
 * Extracts and validates NDC mappings from RXNSAT bronze table
 * Creates a clean rxcui-to-ndc mapping table for gold layer temporal versioning
 */
class RxnormNdcMappingsStack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    const silverPath = `s3://${bucketName}/silver/${dataset}/`;
    ...
    this.silverPath = silverPath;
  }
}

module.exports = { RxnormNdcMappingsStack };
