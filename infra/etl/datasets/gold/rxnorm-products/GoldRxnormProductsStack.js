 ...
 * Applies temporal versioning (SCD Type 2) to silver RxNORM data
 * Partitions by status (current/historical) for efficient queries
 */
class GoldRxnormProductsStack extends cdk.Stack {
  constructor(scope, id, props) {
    ...
    const rxnormProductsConfig = require("../../silver/rxnorm-products/config.json");
    ...
    const silverTable = rxnormProductsConfig.dataset.replace(/-/g, '_');
...
module.exports = { GoldRxnormProductsStack };
