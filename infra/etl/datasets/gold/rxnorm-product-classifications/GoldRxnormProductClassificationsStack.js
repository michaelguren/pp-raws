...
/**
 * RxNORM Product Classifications Gold Layer Stack
 * Applies temporal versioning (SCD Type 2) to RxClass drug-class relationships
 * Partitions by status (current/historical) for efficient queries
 * Supports bidirectional queries: drug→classes and class→drugs
 */
class GoldRxnormProductClassificationsStack extends cdk.Stack {
...
module.exports = { GoldRxnormProductClassificationsStack };
